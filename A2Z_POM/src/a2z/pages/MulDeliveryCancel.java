...
public class MulDeliveryCancel 
{
	...
	public MulDeliveryCancel(AndroidDriver<WebElement> driver)
	{
		this.driver=driver;
	}
	...
	public void mulDeliveryCancellation(Properties obj) throws InterruptedException
	{
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath(obj.getProperty("Cancel_Deliveries"))).click();
		Thread.sleep(2000);
