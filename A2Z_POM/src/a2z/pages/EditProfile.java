...
public class EditProfile
{
	...
	public EditProfile(AndroidDriver<WebElement> driver)
	{
		this.driver=driver;
	}
	...
	Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Name"))).get(1).sendKeys("Seema Phalke");
		
		//editing Flat No
		driver.findElements(By.xpath(obj.getProperty("Flat_No"))).get(2).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Flat_No"))).get(2).sendKeys("F101");
		
		//editing Detail Address
		driver.findElements(By.xpath(obj.getProperty("Detail_Add"))).get(3).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Detail_Add"))).get(3).sendKeys("Royal Building");
		
		//editing Landmark
		driver.findElements(By.xpath(obj.getProperty("Landmark"))).get(4).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Landmark"))).get(4).sendKeys("Bhusari Colony");
				
		//editing Pin code
		driver.findElements(By.xpath(obj.getProperty("Pin_code"))).get(5).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Pin_code"))).get(5).sendKeys("411033");
		
		//editing Area
		driver.findElements(By.xpath(obj.getProperty("Area"))).get(6).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Area"))).get(6).sendKeys("Kothrud");
		...
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Email"))).get(7).sendKeys("pqr@email.com");
		
		//editing Mobile No
		driver.findElements(By.xpath(obj.getProperty("Email"))).get(8).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Email"))).get(8).sendKeys("8888717112");
		
		//editing Alternate No
		driver.findElements(By.xpath(obj.getProperty("Email"))).get(9).clear();
		Thread.sleep(1000);
		driver.findElements(By.xpath(obj.getProperty("Email"))).get(9).sendKeys("9503442111");
