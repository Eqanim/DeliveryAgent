...
{
	@Test
	public void ContactUsMethod() throws InterruptedException, IOException
	{
		...
		ContactUs contct=new ContactUs(driver);
		contct.ContactUsMenu(contct.initial());
	}
}
