...
import a2z.pages.MulDeliveryConfirm;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class MulDeliveryConfirmTest 
{
	@Test
	public void DeliveryConfirm() throws InterruptedException, IOException
	{
		...
		MulDeliveryConfirm confirm=new MulDeliveryConfirm(driver);
		confirm.mulDeliveryConfirmation(confirm.initial());
