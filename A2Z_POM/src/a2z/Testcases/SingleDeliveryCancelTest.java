...
import a2z.pages.SingleDeliveryCancel;

import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class SingleDeliveryCancelTest 
{
	@Test
	public void DeliveryCancel() throws InterruptedException, IOException
	{
		...
		SingleDeliveryCancel cancel=new SingleDeliveryCancel(driver);
		cancel.singleDeliveryCancellation(cancel.initial());
}
}
