...
import a2z.pages.DeliverySummary;
import a2z.pages.LoginPage;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class DeliverySummaryTest
{
	@Test
	public void DeliverySummaryPage() throws InterruptedException, IOException
	{
		...
		DeliverySummary delivery=new DeliverySummary(driver);
		delivery.ViewDeliverySummary(delivery.initial());
	}
}
