...
public class SingleDeliveryConfirmTest 
{
	@Test
	public void DeliveryConfirm() throws InterruptedException, IOException
	{
		...
		SingleDeliveryConfirm confirm=new SingleDeliveryConfirm(driver);
		confirm.singleDeliveryConfirmation(confirm.initial());
