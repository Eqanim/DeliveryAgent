...
import a2z.pages.InvalidEditProfile;
import a2z.pages.LoginPage;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class InvalidEditprofileTest 
{
	@Test
	public void InvalidEditProfile() throws InterruptedException, IOException
	{
		...
		InvalidEditProfile profile=new InvalidEditProfile(driver);
		
		profile.MenuButton(profile.initial());
		profile.ProfileMenu(profile.initial());
		profile.EditingProfile(profile.initial());
	}
}
