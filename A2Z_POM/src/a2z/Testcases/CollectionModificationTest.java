...
import a2z.pages.CollectionModification;
import a2z.pages.LoginPage;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class CollectionModificationTest 
{
	@Test
	public void CollectionModify() throws InterruptedException, IOException
	{
		...
		CollectionModification modify=new CollectionModification(driver);
		modify.CollectionModify(modify.initial());
	}
