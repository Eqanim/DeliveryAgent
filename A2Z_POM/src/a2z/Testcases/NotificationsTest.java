...
import a2z.pages.Notifications;
...
{
	@Test
	public void NotificationRead() throws InterruptedException, IOException
	{
		...
		Notifications notify=new Notifications(driver);
		notify.ReadingNotification(notify.initial());
