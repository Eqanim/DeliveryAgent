...
import a2z.pages.ShuffleCustomer;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class ShuffleCustomerTest 
{
	@Test
	public void Shufflecustomer() throws InterruptedException, IOException
	{
		...
		ShuffleCustomer shuffle=new ShuffleCustomer(driver);
		shuffle.ShufflingCustomer(shuffle.initial());
