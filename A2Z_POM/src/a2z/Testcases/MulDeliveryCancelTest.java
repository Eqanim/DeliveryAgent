...
import a2z.pages.MulDeliveryCancel;
import io.appium.java_client.android.AndroidDriver;
import io.appium.java_client.remote.MobileCapabilityType;

public class MulDeliveryCancelTest 
{
	@Test
	public void DeliveryConfirm() throws InterruptedException, IOException
	{
		...
		MulDeliveryCancel cancel=new MulDeliveryCancel(driver);
		cancel.mulDeliveryCancellation(cancel.initial());
