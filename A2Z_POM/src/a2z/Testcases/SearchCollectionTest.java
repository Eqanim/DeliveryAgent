...
import a2z.pages.SearchCollection;
...
{
	@Test
	public void SearchingCollection() throws InterruptedException, IOException
	{
		...
		SearchCollection search=new SearchCollection(driver);
		search.Searching(search.initial());
	}
}
